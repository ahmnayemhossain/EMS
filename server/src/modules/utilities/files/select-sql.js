import { toCdnUrl } from "../../../shared/storage.js";

export const selectUtilitySql = `
  SELECT ur.*, f.name AS facility_name, s.name AS source_name, cu.username AS created_by_username, uu.username AS updated_by_username,
