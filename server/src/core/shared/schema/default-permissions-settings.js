export const settingsPermissions = [
  "settings:employees:read", "settings:employees:write", "settings:employees:update", "settings:employees:delete",
  "settings:users:read", "settings:users:write", "settings:users:update", "settings:users:delete",
