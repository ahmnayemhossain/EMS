...
export type PermissionGroup = {
  name: string;
  permissions: Partial<Record<PermissionColumn, import("@/pages/settings/modules/settingsEntityApi").PermissionOption>>;
};

export type RolesVm = {
  userId: string;
  roles: RoleEntity[];
  permissions: import("@/pages/settings/modules/settingsEntityApi").PermissionOption[];
  loading: boolean;
  search: string;
