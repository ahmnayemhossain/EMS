...
import { renderChemicalApproval, renderChemicalCompany, renderChemicalExpiry, renderChemicalHazard, renderChemicalName, renderChemicalStock } from "./column-cells";
...
export function getChemicalColumns(): Array<DataColumn<Chemical>> {
  return [
    ...
    { id: "company", header: "Company", cell: renderChemicalCompany, className: "min-w-[220px]" },
