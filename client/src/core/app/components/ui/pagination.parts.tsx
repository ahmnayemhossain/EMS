...
export function PaginationLink({ className, isActive, size = "icon", ...props }: { isActive?: boolean } & Pick<React.ComponentProps<typeof Button>, "size"> & React.ComponentProps<"a">) {
