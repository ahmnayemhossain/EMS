...
export const appRoutes = [{
  ...
  children: [
    { index: true, element: <Navigate to="/utilities" replace /> },
    { path: "index.html", element: <Navigate to="/utilities" replace /> },
    ...
    { path: "companies/:id", element: <Navigate to="/utilities" replace /> },
    { path: "facilities/:id", element: <Navigate to="/utilities" replace /> },
