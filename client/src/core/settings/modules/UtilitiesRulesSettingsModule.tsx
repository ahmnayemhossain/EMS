...
import { listUtilityConversionRules, upsertUtilityConversionRule } from "@/core/settings/modules/utilitiesRulesApi";
      ...
      <div className="grid gap-4 px-4 pb-4 pt-4 sm:grid-cols-2 sm:px-6">
        <Card className="shadow-xs">
          <CardHeader>
            ...
            <CardDescription>
              Electricity source is Generator: kWh = liters × factor.
            </CardDescription>
          </CardHeader>
