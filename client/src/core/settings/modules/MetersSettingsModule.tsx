...
import { listSourceWiringLookups, listUomWiringLookups, type UtilityTypeOption } from "@/core/settings/modules/uomSettingsApi";
import { createMeter, deleteMeter, listMeters, updateMeter, type MeterEntity } from "@/core/settings/modules/metersApi";
    ...
    <div className="grid gap-4">
      ...
      <div className="flex items-center justify-between rounded-lg border bg-muted/30 p-3">
        <div className="min-w-0">
          ...
          <div className="text-xs text-muted-foreground">Inactive meters won’t appear in Utilities selection.</div>
        </div>
