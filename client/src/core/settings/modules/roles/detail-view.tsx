...
import { PermissionListView } from "@/core/settings/modules/roles/permission-list-view";
import { RoleForm } from "@/core/settings/modules/roles/form";
import type { PermissionOption, RoleEntity } from "@/core/settings/modules/settingsEntityApi";
import type { RoleValidationErrors } from "@/core/settings/modules/roles/roles.types";
