import { Building2, Gauge, Mail, MessagesSquare, Ruler, ShieldCheck, SlidersHorizontal, UserRound, UsersRound, Wrench } from "lucide-react";
...
export const settingsRouteDefs: SettingsRouteDef[] = [
  ...
  drawer("email", "communications", "Email setup", "SMTP and sender identity for notifications.", Mail),
