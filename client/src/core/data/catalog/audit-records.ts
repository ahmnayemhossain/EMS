import { audits, facilities } from "@/core/data/catalog/mock";
import type { AuditRecord } from "@/core/types/models/audit";
import { buildAuditFindings } from "@/core/data/catalog/audit-records.findings";
import { collectTemplateItemIds, computeProgress, computeScore, makeRng, pickTemplateId, statusFromRng } from "@/core/data/catalog/audit-records.helpers";
