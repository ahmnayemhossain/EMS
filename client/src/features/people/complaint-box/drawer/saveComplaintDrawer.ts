...
import { createLocalId, type PendingNote } from "@/features/people/complaint-box/drawer/state-helpers";
import type { SaveComplaintDrawerArgs } from "@/features/people/complaint-box/drawer/types";
