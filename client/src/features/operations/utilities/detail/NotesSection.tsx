...
export function NotesSection({ record }: { record: UtilityRecord }) {
  return (
    <>
      <DetailCard><div className="text-muted-foreground text-xs">Remarks</div><div className="mt-1 text-sm break-words">{record.remarks ?? "ÃƒÆ’Ã‚Â¢ÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â"}</div></DetailCard>
