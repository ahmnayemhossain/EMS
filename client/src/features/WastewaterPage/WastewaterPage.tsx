...
import { ResponsiveWidgetGroup } from "@/core/components/ResponsiveWidgetGroup";
import { capas, getFacilityName, wastewaterRecords } from "@/core/data/mock";
...
export function WastewaterPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Wastewater" actions={<WastewaterCreateDialog />} />
