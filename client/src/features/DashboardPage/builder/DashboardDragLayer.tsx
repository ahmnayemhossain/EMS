...
import { useDashboardBuilder } from "@/core/app/state/dashboard-builder";
...
import { getItemStyles, layerStyles, PREVIEW_COL, PREVIEW_GAP, PREVIEW_ROW_HEIGHT } from "./drag-layer.helpers";
import { DragLayerLabel } from "./drag-layer.label";
...
export function DashboardDragLayer() {
  ...
  return (
    <div style={layerStyles()}>
      <div style={getItemStyles(currentOffset)}><DragPreviewCard width={width} height={height} label={label} /></div>
    </div>
  );
}
